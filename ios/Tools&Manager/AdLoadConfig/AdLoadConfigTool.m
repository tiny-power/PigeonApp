...
+ (void)interstitial_loadExtraConfigAppend_KuaiShou:(NSMutableDictionary *)config {
    if (!config) {
        NSLog(@"⚠️interstitial_loadExtraConfigAppend_KuaiShou: Input config instance is null");
    }
    CGSize size = CGSizeMake([UIScreen mainScreen].bounds.size.width - 30.0f, 300.0f);
...
+ (void)rewarded_loadExtraConfigAppend_Klevin:(NSMutableDictionary *)config {
    if (!config) {
      NSLog(@"⚠️splash_loadExtraConfigAppend_Klevin: Input config instance is null");
    }
...
+ (void)splash_loadExtraConfigAppend_Pangle:(NSMutableDictionary *)config {
    if (!config) {
      NSLog(@"⚠️splash_loadExtraConfigAppendPangle: Input config instance is null");
    }
...
+ (void)splash_loadExtraConfigAppend_Tencent:(NSMutableDictionary *)config {
    if (!config) {
      NSLog(@"⚠️splash_loadExtraConfigAppend_Tencent: Input config instance is null");
    }
...
+ (void)native_loadExtraConfigAppend_SizeToFit:(NSMutableDictionary *)config {
    if (!config) {
      NSLog(@"⚠️native_loadExtraConfigAppend_SizeToFit: Input config instance is null");
    }
...
+ (void)native_loadExtraConfigAppend_KuaiShou_SlideOrClickAble:(NSMutableDictionary *)config {
    if (!config) {
      NSLog(@"⚠️native_loadExtraConfigAppend_KuaiShou_SlideOrClickAble: Input config instance is null");
    }
